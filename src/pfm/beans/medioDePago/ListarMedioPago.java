...
public class ListarMedioPago implements Serializable {
	...
	public void setModificarMedioPagoBEAN(
			ModificarMedioPago modificarMedioPagoBEAN) {
	...
	public void onCancel(RowEditEvent event) {
		...
		FacesMessage msg = new FacesMessage("Medio de Pago cancelado",
	...
	public String onBaja() {
		if (selectedMedioPagos.length > 0) {
			for (MedioDePago m : selectedMedioPagos) {
